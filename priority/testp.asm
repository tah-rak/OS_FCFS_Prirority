...
int main() {
  ...
  5b:	ff 74 9d cc          	push   -0x34(%ebp,%ebx,4)
  5f:	68 ac 08 00 00       	push   $0x8ac
  64:	6a 01                	push   $0x1
  66:	e8 75 04 00 00       	call   4e0 <printf>
        printf(1, "  Creation time: %d\n", pstat_info.ctime);
  6b:	83 c4 0c             	add    $0xc,%esp
  6e:	ff 75 d4             	push   -0x2c(%ebp)
  71:	68 52 08 00 00       	push   $0x852
  76:	6a 01                	push   $0x1
  78:	e8 63 04 00 00       	call   4e0 <printf>
        printf(1, "  End time: %d\n", pstat_info.etime);
  7d:	83 c4 0c             	add    $0xc,%esp
  80:	ff 75 d8             	push   -0x28(%ebp)
  83:	68 67 08 00 00       	push   $0x867
  88:	6a 01                	push   $0x1
  8a:	e8 51 04 00 00       	call   4e0 <printf>
        printf(1, "  Total time: %d\n\n", pstat_info.ttime);
  8f:	83 c4 0c             	add    $0xc,%esp
  92:	ff 75 dc             	push   -0x24(%ebp)
  95:	68 77 08 00 00       	push   $0x877
  9a:	6a 01                	push   $0x1
  9c:	e8 3f 04 00 00       	call   4e0 <printf>
    for (int i = 0; i < num_commands; i++) 
  a1:	83 c4 10             	add    $0x10,%esp
  a4:	83 fb 01             	cmp    $0x1,%ebx
  a7:	75 07                	jne    b0 <main+0xb0>
    }

    exit();
  a9:	e8 c5 02 00 00       	call   373 <exit>
  ae:	66 90                	xchg   %ax,%ax
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 2c 09 00 00 	movzbl 0x92c(%edx),%edx
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 559:	ff 24 85 d4 08 00 00 	jmp    *0x8d4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba cb 08 00 00       	mov    $0x8cb,%edx
        while(*s != 0){
