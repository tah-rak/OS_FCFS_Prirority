...
_writefile:     file format elf32-i386
 ...
 719:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 897:	90                   	nop
          s = "(null)";
 898:	ba c1 0a 00 00       	mov    $0xac1,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8b1:	a1 d4 0d 00 00       	mov    0xdd4,%eax
{
 ...
 8f1:	5b                   	pop    %ebx
  freep = p;
 8f2:	89 15 d4 0d 00 00    	mov    %edx,0xdd4
}
 8f8:	5e                   	pop    %esi
 8f9:	5f                   	pop    %edi
 8fa:	5d                   	pop    %ebp
 ...
 929:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 92c:	89 15 d4 0d 00 00    	mov    %edx,0xdd4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 949:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 94c:	8b 3d d4 0d 00 00    	mov    0xdd4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 98f:	73 4f                	jae    9e0 <malloc+0xa0>
    ...
    if(p == freep)
 991:	8b 3d d4 0d 00 00    	mov    0xdd4,%edi
 ...
 9ba:	e8 f1 fe ff ff       	call   8b0 <free>
  return freep;
 9bf:	8b 15 d4 0d 00 00    	mov    0xdd4,%edx
 ...
 9ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9ef:	89 15 d4 0d 00 00    	mov    %edx,0xdd4
}
 ...
 9ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a00:	c7 05 d4 0d 00 00 d8 	movl   $0xdd8,0xdd4
 a07:	0d 00 00 
    base.s.size = 0;
 a0a:	bf d8 0d 00 00       	mov    $0xdd8,%edi
    base.s.ptr = freep = prevp = &base;
 a0f:	c7 05 d8 0d 00 00 d8 	movl   $0xdd8,0xdd8
 a16:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a19:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a1b:	c7 05 dc 0d 00 00 00 	movl   $0x0,0xddc
 a22:	00 00 00 
    if(p->s.size >= nunits){
